...
const SEEDS: CreatureSeed[] = [
  ...
  { id: 'jellyfish', label: '해파리', level: 1, tone: 'rgba(150, 145, 220, 0.5)', enemyDesc: '심연을 부유하는 반투명 포식자. 스치는 촉수마다 저릿한 냉기를 흘린다.', enemyPassive: '감전 촉수 — 아군을 공격할 때 피해를 1 추가로 준다.', enemyPassiveId: 'ferocious', passive: '감전 점막 — 이 칸에 있는 적이 받는 피해가 1 증가한다.', passiveId: 'jelly-amp' },
  ...
  { id: 'shrimp', label: '새우', level: 4, tone: 'rgba(235, 175, 140, 0.45)', enemyDesc: '투명한 등을 튕기며 재빠르게 헤엄치는 작은 갑각류.', enemyPassive: '얇은 갑각 — 받는 피해가 1 감소한다.', enemyPassiveId: 'armor', passive: '탈피 — 단단한 겉껍질로 더 많은 체력을 지니고 배치된다.', passiveId: 'crab-guard' },
  ...
  { id: 'starfish', label: '불가사리', level: 6, tone: 'rgba(215, 155, 195, 0.45)', enemyDesc: '느릿하게 바닥을 기며 잃은 팔도 다시 돋우는 붉은 별.', enemyPassive: '재생 팔 — 교전 중이 아닐 때 체력을 조금씩 회복한다.', enemyPassiveId: 'regen', passive: '재생 팔 — 두꺼운 몸으로 더 많은 체력을 지니고 배치된다.', passiveId: 'crab-guard' },
  { id: 'hermit-crab', label: '소라게', level: 7, tone: 'rgba(80, 65, 100, 0.55)', enemyDesc: '남의 소라 껍데기를 빌려 짊어진 수줍은 방랑자.', enemyPassive: '소라 방패 — 받는 피해가 1 감소한다.', enemyPassiveId: 'armor', passive: '빌린 껍데기 — 단단한 소라로 더 많은 체력을 지니고 배치된다.', passiveId: 'crab-guard' },
  ...
  { id: 'scallop', label: '가리비', level: 9, tone: 'rgba(180, 190, 205, 0.45)', enemyDesc: '조가비를 여닫으며 통통 튀어 이동하는 부채꼴 조개.', enemyPassive: '조가비 방패 — 받는 피해가 1 감소한다.', enemyPassiveId: 'armor', passive: '조가비 방패 — 두꺼운 조가비로 더 많은 체력을 지니고 배치된다.', passiveId: 'crab-guard' },
  ...
  { id: 'seahorse', label: '해마', level: 11, tone: 'rgba(100, 130, 185, 0.45)', enemyDesc: '꼬리를 말아 해초에 매달린 채 잔잔히 떠 있는 물고기.', enemyPassive: '골판 비늘 — 받는 피해가 1 감소한다.', enemyPassiveId: 'armor', passive: '잔잔한 물결 — 처치될 때 인접한 아군의 체력을 회복시킨다.', passiveId: 'rabbit-heal' },
  { id: 'crab', label: '꽃게', level: 12, tone: 'rgba(205, 70, 75, 0.46)', enemyDesc: '두꺼운 등껍질로 몸을 감싼 심연의 파수꾼. 좀처럼 무너지지 않는다.', enemyPassive: '단단한 등껍질 — 받는 피해가 1 감소한다.', enemyPassiveId: 'armor', passive: '단단한 등껍질 — 두꺼운 껍질로 더 많은 체력을 지니고 배치된다.', passiveId: 'crab-guard' },
  { id: 'octopus', label: '문어', level: 13, tone: 'rgba(180, 85, 110, 0.5)', enemyDesc: '여덟 팔로 먹물을 흩뿌리며 그늘 속으로 스미는 지능적 포식자.', enemyPassive: '여덟 팔 — 그 칸의 모든 아군을 한꺼번에 공격한다.', enemyPassiveId: 'cleave', passive: '여덟 팔 — 그 칸의 모든 적을 한꺼번에 공격한다.', passiveId: 'cleave' },
  { id: 'squid', label: '오징어', level: 14, tone: 'rgba(195, 195, 210, 0.5)', enemyDesc: '제트 분사로 쏘아지듯 헤엄치며 먹물 장막을 치는 두족류.', enemyPassive: '먹물 장막 — 그 칸의 모든 아군을 한꺼번에 공격한다.', enemyPassiveId: 'cleave', passive: '먹물 장막 — 그 칸의 모든 적을 한꺼번에 공격한다.', passiveId: 'cleave' },
  // ── elites (round bosses). Enemy stats come from WaveSystem.ELITE_BY_WAVE;
  //    level here only feeds their captured-ally / codex stats. ──
  { id: 'piranha', label: '피라냐', level: 7, tone: 'rgba(85, 140, 115, 0.5)', enemyDesc: '굶주린 이빨을 드러내며 떼로 달려드는 사나운 물고기.', enemyPassive: '굶주린 이빨 — 아군을 잡아먹으면 공격력이 오른다.', enemyPassiveId: 'devour', passive: '굶주린 이빨 — 적을 잡아먹을 때마다 공격력이 영구히 오른다.', passiveId: 'devour' },
  ...
  { id: 'marlin', label: '청새치', level: 11, tone: 'rgba(95, 100, 185, 0.5)', enemyDesc: '긴 창부리를 앞세워 바다를 가르며 돌진하는 청빛 사냥꾼.', enemyPassive: '관통 창 — 그 칸의 모든 아군을 한꺼번에 꿰뚫는다.', enemyPassiveId: 'cleave', passive: '관통 창 — 그 칸의 모든 적을 한꺼번에 꿰뚫는다.', passiveId: 'cleave' },
  { id: 'whale', label: '고래', level: 13, tone: 'rgba(140, 150, 200, 0.5)', enemyDesc: '심연을 가득 메우는 거구. 그 그림자만으로 물이 무겁다.', enemyPassive: '심연의 거구 — 받는 피해가 1 감소한다.', enemyPassiveId: 'armor', passive: '심연의 거구 — 압도적인 체력을 지니고 배치된다.', passiveId: 'crab-guard' },
  { id: 'shark', label: '상어', level: 14, tone: 'rgba(125, 130, 190, 0.5)', enemyDesc: '심연의 지배자. 날카로운 이빨과 무자비한 속도로 모든 것을 삼킨다.', enemyPassive: '심연의 이빨 — 아군을 잡아먹으면 공격력이 오른다.', enemyPassiveId: 'devour', passive: '심연의 이빨 — 적을 잡아먹을 때마다 공격력이 영구히 오른다.', passiveId: 'devour' },
]
